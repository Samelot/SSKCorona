...
-- Utility methods
-- =====================================================
require("com.roaminggamer.ssk.RGFiles.RGFiles_util").attach( RGFiles )
...
-- =====================================================
require("com.roaminggamer.ssk.RGFiles.RGFiles_systemDocuments").attach( RGFiles )
require("com.roaminggamer.ssk.RGFiles.RGFiles_systemResource").attach( RGFiles )
require("com.roaminggamer.ssk.RGFiles.RGFiles_systemTemporary").attach( RGFiles )
require("com.roaminggamer.ssk.RGFiles.RGFiles_desktop").attach( RGFiles )
require("com.roaminggamer.ssk.RGFiles.RGFiles_tests").attach( RGFiles )
