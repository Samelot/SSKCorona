...
local function create( group, params )
	...
	local button1Mask 		= params.button1Mask or "com/roaminggamer/ssk/RGEasyInputs/halftouchA1M.png"
	local button2Mask 		= params.button2Mask or "com/roaminggamer/ssk/RGEasyInputs/halftouchA2M.png"
